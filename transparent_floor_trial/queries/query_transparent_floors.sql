...
select brd.*, brr.bidder is not null as bidder_responded, brr.bid_cpm bid_cpm
...
select domain, date, bidder, test_name_str, test_group,
    ...
    avg(if(winning_bidder is not null and bidder_response_known, safe_divide(bid_cpm, bid_cpm_winning_bidder), null)) bidder_price_pressure_include_non_bids,
    avg(if((winning_bidder is not null) and bidder_responded and bidder_response_known, safe_divide(bid_cpm, bid_cpm_winning_bidder), null)) bidder_price_pressure_bids,
    avg(if((winning_bidder is not null) and bidder_responded and bidder_response_known and bidder = winning_bidder, safe_divide(bid_cpm, bid_cpm_winning_bidder), null)) bidder_price_pressure_wins,
    avg(if(winning_bidder is not null and bidder_response_known, if(bid_cpm >= 0.8 * bid_cpm_winning_bidder, 1, 0), null)) bidder_within_20perc_include_non_bids,
    avg(if((winning_bidder is not null) and bidder_responded and bidder_response_known, if(bid_cpm >= 0.8 * bid_cpm_winning_bidder, 1, 0), null)) bidder_within_20perc_bids,
    avg(if(winning_bidder is not null and bidder_response_known, if(bid_cpm >= 0.5 * bid_cpm_winning_bidder, 1, 0), null)) bidder_within_50perc_include_non_bids,
    avg(if((winning_bidder is not null) and bidder_responded and bidder_response_known, if(bid_cpm >= 0.5 * bid_cpm_winning_bidder, 1, 0), null)) bidder_within_50perc_bids,
