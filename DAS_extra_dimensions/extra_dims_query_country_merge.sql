with base_with_extra_dim_raw_country_code as (
    ...
    select bidder, rtt_category, fsrefresh, country_code, device_category, <EXTRA_DIM>
        from base_with_extra_dim_raw_country_code
    ...
    from base_with_extra_dim_raw_country_code b
