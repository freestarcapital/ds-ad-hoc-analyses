...
CREATE OR REPLACE TABLE `{project_id}.DAS_eventstream_session_data.bidder_session_data_raw_domain_{aer_to_bwr_join_type}_{processing_date}_{days_back_start}_{days_back_end}`
    OPTIONS (
