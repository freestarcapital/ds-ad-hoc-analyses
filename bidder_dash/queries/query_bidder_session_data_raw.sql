...
select date, ts, country_code, fs_testgroup, fs_clientservermask, fs_session_id, device_category, winning_bidder, revenue,
    from session_agg
...
select country_code, fs_testgroup, fs_session_id, device_category, bidder, status, date, ts,
    if(bidder=winning_bidder, revenue, 0) revenue
from expanded
