...
from `streamamp-qa-239417.training.floors_vertex_devbrowser-signal_green_28042025_expt_1`
), t_user as (
...
from t_user
join t_no_user using (device_category_raw, date, hour_x, hour_y, country_code, ad_unit_name)
join t_prod using (device_category_raw, date, hour_x, hour_y, country_code, ad_unit_name)
