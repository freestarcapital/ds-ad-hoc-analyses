...
CREATE OR REPLACE TABLE `{project_id}.DAS_eventstream_session_data.eventstream_DAS_expt_stats_split_revenue_winning_bidder_LJ_{processing_date}_{days_back_start}_{days_back_end}`
    OPTIONS (
...
select country_code, fs_clientservermask, fs_session_id, device_category, winning_bidder, date, revenue
