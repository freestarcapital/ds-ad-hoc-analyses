...
CREATE OR REPLACE TABLE `{project_id}.DAS_eventstream_session_data.eventstream_DAS_opt_stats_split_revenue_{processing_date}_{days_back_start}_{days_back_end}`
    OPTIONS (
